...
import com.formaloo.common.GlideImageGetter
import com.formaloo.common.MyTagHandler
import com.formaloo.data.model.form.ChoiceItem
import com.formaloo.data.model.form.Fields
import com.formaloo.data.model.form.Form
import com.formaloo.feature.drawer.SortedLessonListAdapter
import com.formaloo.feature.lesson.adapter.LessonFieldsAdapter
import com.formaloo.feature.lesson.adapter.holder.DropDownItemsAdapter
...
object Binding : KoinComponent {
    ...
    fun loadImage(view: ImageView, url: String?) {
        val source = url ?: ContextCompat.getDrawable(
            view.context,
            com.formaloo.feature.R.drawable.startup
        )
        ...
        val descPlus = when (type) {
            Constants.SHORT_TEXT -> {
                if (field.max_length != null) {
                    context.getString(com.formaloo.feature.R.string.max_char_lenght) + " : " + field.max_length

...
import com.formaloo.feature.databinding.LayoutFlashCardMultiItemBinding
import com.formaloo.feature.Binding
    ...
    private fun createCheckBox(
        ...
        checkBox.apply {
            ...
            setTextSize(
                ...
                context.resources.getDimension(com.formaloo.feature.R.dimen.font_xlarge)
            )
    ...
    private fun setImage(it: String, box: CheckBox) {
        Picasso.get().load(it).into(object : Target {
            override fun onBitmapLoaded(bitmap: Bitmap?, from: Picasso.LoadedFrom?) {
                bitmap?.let {
                    val padding =
                        box.resources.getDimensionPixelSize(com.formaloo.feature.R.dimen.padding_2xsmall)
                    val height =
                        box.resources.getDimensionPixelSize(com.formaloo.feature.R.dimen.btn_h)
